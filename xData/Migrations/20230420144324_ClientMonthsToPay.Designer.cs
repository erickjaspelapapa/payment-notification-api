...
namespace xData.Migrations
{
    ...
    [Migration("20230420144324_ClientMonthsToPay")]
    partial class ClientMonthsToPay
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("xDomain._91128.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            addressTx = "address",
                            contactTx = "contact",
                            created_dt = new DateTime(2023, 4, 20, 22, 43, 23, 828, DateTimeKind.Local).AddTicks(8384),
                            ...
                            middleNm = "Admin",
                            passwordTx = "p@ssw0rd",
                            updated_dt = new DateTime(2023, 4, 20, 22, 43, 23, 828, DateTimeKind.Local).AddTicks(8393),
                            usernameTx = "Admin"
                        });
                });
