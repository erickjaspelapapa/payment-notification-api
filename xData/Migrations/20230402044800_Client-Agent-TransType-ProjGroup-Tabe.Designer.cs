...
namespace xData.Migrations
{
    ...
    [Migration("20230402044800_Client-Agent-TransType-ProjGroup-Tabe")]
    partial class ClientAgentTransTypeProjGroupTabe
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("xDomain._91128.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            addressTx = "address",
                            contactTx = "contact",
                            created_dt = new DateTime(2023, 4, 2, 12, 48, 0, 708, DateTimeKind.Local).AddTicks(2110),
                            ...
                            middleNm = "Admin",
                            passwordTx = "p@ssw0rd",
                            updated_dt = new DateTime(2023, 4, 2, 12, 48, 0, 708, DateTimeKind.Local).AddTicks(2123),
                            usernameTx = "Admin"
                        });
                });
