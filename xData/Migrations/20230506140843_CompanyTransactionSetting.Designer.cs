...
namespace xData.Migrations
{
    ...
    [Migration("20230506140843_CompanyTransactionSetting")]
    partial class CompanyTransactionSetting
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("xDomain._91128.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            addressTx = "address",
                            contactTx = "contact",
                            created_dt = new DateTime(2023, 5, 6, 22, 8, 40, 753, DateTimeKind.Local).AddTicks(7657),
                            ...
                            middleNm = "Admin",
                            passwordTx = "p@ssw0rd",
                            updated_dt = new DateTime(2023, 5, 6, 22, 8, 40, 753, DateTimeKind.Local).AddTicks(7668),
                            usernameTx = "Admin"
                        });
                });
